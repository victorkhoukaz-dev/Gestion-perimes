...
// 3. Désactiver l'initialisation harcodée de rawData à la démo de 1.78M$
...
console.log('Successfully updated generics_monthly.html with valid HTML comment boundaries.');
