...
// 1. Remplacer showGenericsModulePreview par openGenericsModule dans le hub et le menu
html = html.replaceAll('showGenericsModulePreview();', 'openGenericsModule();');

// 2. Mettre à jour openExpiresModule pour masquer le wrapper des génériques et ré-afficher nav-tabs
...
console.log('Successfully updated index.html to open openGenericsModule directly.');
