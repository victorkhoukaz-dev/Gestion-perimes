-- =============================================================================
-- PHARMAOPS - CONSOLIDATED SECURITY MIGRATION 2A-2F (ROLLBACK TEST)
-- =============================================================================
...
drop policy if exists "Permettre l'insertion ÃƒÂ  l'inscription" on public.pharmacies;
...
drop policy if exists "Seul le propriÃƒÂ©taire peut lire les achats gÃƒÂ©nÃƒÂ©riques"
on public.generics_purchases;
drop policy if exists "Seul le propriÃƒÂ©taire peut ÃƒÂ©crire les achats gÃƒÂ©nÃƒÂ©riques"
on public.generics_purchases;
...
select
  'PASS - all checks succeeded; transaction will now roll back' as rollback_test_result;
