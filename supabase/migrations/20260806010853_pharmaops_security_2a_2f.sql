-- =============================================================================
-- PHARMAOPS - CONSOLIDATED SECURITY MIGRATION 2A-2F (PRODUCTION CANDIDATE)
-- =============================================================================
-- STATUS: PRODUCTION CANDIDATE - NOT YET APPROVED FOR EXECUTION.
--
...
--
-- IMPORTANT:
--   1. Run only after rollback rehearsal and explicit production approval.
...
-- =============================================================================
-- 1. Confirm this candidate differs from the rollback-tested migration only by
--    removal of the deliberate DRAFT ONLY safety stop and status comments.
